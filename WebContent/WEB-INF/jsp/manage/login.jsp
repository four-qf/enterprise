...
<div id="main2">
 ...
 <div class="tittle2">后台管理中心/ <b>Manager</b></div>
  <div class="left">
    <div class="left-nav">
      <ul>
       <li><a href='#' class='red'>后台管理中心</a></li>  
      </ul>
    </div>
    <div class="phone-bj">
      <div class="phone">
 ...
 <div class="right"><div class="weizhi">您现在的位置：<a href="#">后台管理</a> &gt; <a href="#">管理员登录登录</a></div>
    ...
    <table width="605" border="0" cellspacing="0" cellpadding="0" style="margin:0 auto">
        ...
        <td width="230" align="right"><input type="text" class="name" name="managerid" id="managerid"></td>
        ...
        <td width="230" align="left"><input type="submit" class="login2" value=""></td>
        <td>&nbsp;</td>
        </tr>
