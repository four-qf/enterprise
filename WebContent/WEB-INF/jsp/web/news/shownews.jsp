    ...
    <div class="languages"><A href="/enterprise/web/login" class="bg">登录</A>|<a href="/enterprise/web/regist"><b>注册</b></a></div>
      ...
      <li><a href='/enterprise/web/product/list' class="privilege">产品中心</a>
        <div class='secondary'>
          ...
          <p><a privilege href='/enterprise/web/product/list'>更多...</a></p>
          </div>
...
<div id="main2">
  ...
  <div class="left">
    ...
    <div class="left-nav">
      ...
      <ul>
       <c:forEach items="${newskinds }" var="newskind" >
        <li><a href="/enterprise/web/news/list/${newskind.kindid }" class="red">${newskind.kindname }</a></li>
       </c:forEach>
      </ul>
  ...
  <div class="right">
    ...
    <div class="weizhi">您现在的位置：<a href='#'>${news.newskind.kindname }</a></div>

    <div class="news-zxxq">

    	<h2>${news.newstitle }</h2>

      <div class="time">发布时间：${news.createtime }</div>
